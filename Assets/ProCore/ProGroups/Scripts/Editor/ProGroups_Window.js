...
class ProGroups_Window extends EditorWindow 
{
	...
	var icon_Rect : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_Rect.png", typeof(Texture2D));
	var icon_SnowFlake : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_SnowFlake.png", typeof(Texture2D));
	var icon_Eye : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_Eye.png", typeof(Texture2D));
	var icon_Select : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_Select.png", typeof(Texture2D));
	var icon_UpdateGroup : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_UpdateGroup.png", typeof(Texture2D));
	var icon_MoveUp : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_MoveUp.png", typeof(Texture2D));
	var icon_Delete : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_Delete.png", typeof(Texture2D));
	var icon_Gear : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_Gear.png", typeof(Texture2D));
	var icon_Add : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_Add.png", typeof(Texture2D));
	var icon_MultiPlus : Texture2D = AssetDatabase.LoadAssetAtPath(guiPath+"ProGroupsIcons_MultiPlus.png", typeof(Texture2D));
